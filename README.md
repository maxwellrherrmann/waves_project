...
The CFL condition for the wave equation is the term in parentheses in eq. \ref{eq:discrete_wave}, $\frac{v \Delta t}{\Delta x}$, which must be less than one for this formulation of the discrete wave equation. 
...
Consider the Taylor series expansions of $u(x_0 + \Delta x,y)$ and $u(x_0 - \Delta x,y)$:
\begin{align}
